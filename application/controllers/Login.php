...
class Login extends MY_Controller {
	...
	public function index() 
	{
		...
		if($this->session->userdata('logged_in')){
			$not_redirectable = array("http://staging-baselist.herokuapp.com/", "http://baselist.herokuapp.com/", "http://baselist/","http://staging-baselist.herokuapp.com/Marketing/loaddata","http://baselist.herokuapp.com/Marketing/loaddata","http://localhost:8888/baselist/Marketing/loaddata");
