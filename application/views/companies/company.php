...
<hr>
    ...
    <a class="btn  btn-default btn-sm btn-block " href="https://www.google.co.uk/search?q=<?php echo str_replace('&','',$company['name']);  ?>"  target="_blank">Google <i class="fa fa-search" aria-hidden="true"></i></a>
            <?php endif; ?>
