...
<div class="row page-results-list">
	...
	<div class="panel <?php if(isset($company->company_assigned_to)): ?> panel-primary <?php else: ?> panel-default <?php endif; ?> company ">
				...
				<div class="btn-group pull-right assign-to-wrapper">
					<?php if(isset($company->company_assigned_to) and !empty($company->company_assigned_to)): ?>
						<?php if($company->company_assigned_to_id == $current_user['id']) : ?>			
							...
							<?php echo form_close(); ?>
						<?php else: ?>
							<button class="btn  btn-primary " disabled="disabled"><?php  echo 'Assigned to '.$company->company_assigned_to; ?></button>
						<?php endif; ?>
					<?php else: ?>
					<?php 
