...
<hr>
	...
	<?php if (($current_user['department']) =='support' && isset($company['zendesk_id'])): ?>
		...
		$name_no_ltd = str_replace($words, '',$company['name']); ?>
              ...
              <a class="btn  btn-primary btn-sm btn-block" href="https://www.linkedin.com/vsearch/f?type=all&keywords=<?php echo  urlencode($name_no_ltd) ?>"  target="_blank"><i class="fa fa-search" aria-hidden="true"></i> Search LinkedIn</a>
            <?php endif; ?>
