              ...
              <div class="panel-body">
                  ...
                  <div class="list-group">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li <?php if (($_GET['period'] == 'this') ||  (empty($_GET['period'])) && ($_GET['search'] !=='3')): ?>class="active"<?php endif; ?>><a href="#this" role="tab" data-toggle="tab">This Week</a></li>
                    ...
                    <!-- Tab panes -->
                    <div class="tab-content">
                      <div class="tab-pane fade <?php if (($_GET['period'] == 'this') ||  (empty($_GET['period'])) && ($_GET['search'] !=='3')): ?>active in <?php endif; ?>" id="this">
                      <div class="col-md-12">
                      <div class="row list-group-item">
                        <div class="col-xs-2 col-md-1 hide-overflow"> 
                            <strong>Name</strong>
