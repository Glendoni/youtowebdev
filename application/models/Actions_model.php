...
{       
    $this->db->select("actions.company_id, actions.id as action_id,comments,planned_at,action_type_id,name as company_name,contacts.first_name,contacts.last_name,contacts.phone as contact_phone,contacts.email, to_char(planned_at, 'HH24:MI DD/MM/YY') as duedate, companies.phone as company_phone, companies.pipeline ");
