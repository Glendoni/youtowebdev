	...
	function get_recent_stats($period){
		...
		$end_date = $dates['end_date'];
	 	$sql = "select U.name, U.id as user, U.image,
				...
				sum(case when (cancelled_at is null and (action_type_id = '4' or action_type_id = '5') or (action_type_id = '11' and actioned_at is not null)) then 1 else 0 end) salescalls,
