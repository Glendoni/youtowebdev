...
<div class="panel-heading"><h4>Contact Commentary</h4></div>
...
<textarea name="comment" id="comment" rows="3" class="form-control" required style="width:100%"></textarea>
</div>
<div class="col-md-4">
...
WHERE CB.user_id = U.user_id AND CB.business_id = ".$business_id." order by CB.date desc");
